  ...
  function renderBrand() {
    ...
    return `<div class="editor-panel">
      ...
      <section class="editor-section browser-brand-section" open>
        <summary><strong>Tab trình duyệt & nhận diện website</strong><span>Hiển thị trên tab, bookmark và kết quả chia sẻ</span></summary>
        <div class="editor-section-body">
          <div class="field-grid">
      ...
      <section class="editor-section" open>
        <summary><strong>Nhận diện Header dùng chung</strong><span>Thay một lần và áp dụng đồng thời cho Desktop + Mobile</span></summary>
        <div class="editor-section-body">
          <div class="field-grid">
  ...
  function socialLinksEditor(card, cardIndex) {
    ...
    return `<div class="social-links-manager full">
      <div class="social-links-manager-heading">
        <div><strong>Các nền tảng Social</strong><small>Mỗi dòng có logo và link riêng. Để trống link thì nền tảng đó sẽ không hiển thị.</small></div>
